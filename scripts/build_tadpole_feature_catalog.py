...
def main() -> int:
    ...
    parser.add_argument("--dictionary", default="data/tadpole_challenge/TADPOLE_D1_D2_Dict.csv")
    parser.add_argument("--d3", default="data/tadpole_challenge/TADPOLE_D3.csv")
    parser.add_argument("--output-csv", default="outputs/metrics/tadpole_full_feature_catalog.csv")
    parser.add_argument("--output-md", default="docs/tadpole_full_feature_catalog.md")
    parser.add_argument("--modality-map-md", default="docs/tadpole_full_modality_map.md")
    ...
    write_feature_catalog(catalog, args.output_csv, args.output_md, modality_map_md=args.modality_map_md)
